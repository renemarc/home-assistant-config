...
#### [▶️ Listen to the following audio sample:](https://instaud.io/2Eye?autoplay=1)
> 
> **(( bell ))**
> 
...
#### [▶️ Listen to the following audio sample:](https://instaud.io/2Idw?autoplay=1)
>
> **(( alarm ))**
> 
...
#### [▶️ Listen to the following audio sample:](https://instaud.io/2IdA?autoplay=1)
> 
> **(( alarm ))**
> 
...
Radon (Rn) is an element that comes from the natural decay of underground uranium, thorium, and radium. It is a radioactive, colorless, and odorless noble gas. Radon tends to accumulate in enclosed locations like houses. It has a short half-life of 3.8 days before decaying into non-gaseous, sticky radioactive elements. This means that when breathing in air or dust particles, radioactive elements can be deposited inside the lungs, increasing the odds of developping lung cancer. Keeping a place well ventilated is a good way to migitage this risk.
...
#### References:
- https://airthings.com/us/radon-levels/
- https://en.wikipedia.org/wiki/Radon#Concentration_scale
- https://www.who.int/news-room/fact-sheets/detail/radon-and-health

#### [▶️ Listen to the following audio sample:](https://instaud.io/2IeI?autoplay=1)
> 
> **(( alarm ))**
> 
